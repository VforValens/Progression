...
export class PMCs {
	...
	private generatePmcs() {
		...
		const eyewearLL2 = eyewearLL1.concat(...["5d5fca1ea4b93635fd598c07"]);
		...
		const tacticalVestLL3 = ["61bc85697113f767765c7fe7"];
				...
				},
				{
					...
					generation: {
						drugs: {
							...
							whitelist: {
								"590c695186f7741e566b64a2": 5,
								"5755383e24597772cb798966": 2,
						...
						healing: {
							...
							whitelist: {
								"60098af40accd37ef2175f27": 2,
								"5751a25924597722c463c472": 2,
								"5af0454c86f7746bf20992e8": 2,
						...
						stims: {
							...
							whitelist: {
								"544fb3f34bdc2d03748b456a": 2,
								"5c0e531286f7747fa54205c2": 1,
								"5fca138c2a7b221b2852a5c6": 1,
								"5c10c8fd86f7743d7d706df3": 2,
				...
				},
				{
					...
					generation: {
						drugs: {
							...
							whitelist: {
								"5af0548586f7743a532b7e99": 3,
								"5755383e24597772cb798966": 3,
						...
						grenades: {
							...
							whitelist: {
								...
								"5e32f56fcb6d5863cc5e5ee4": 9,
								"5e340dcdcb6d5863cc5e5efb": 9,
							},
						},
						healing: {
							weights: {
		...
		const progressionWhitelistLL2PMC: IEquipmentFilterDetails = {
			levelRange: {
				min: lvl.loyalty2.min,
				max: lvl.loyalty2.max,
			},
		...
		const progressionWhitelistLL2PMCWide: IEquipmentFilterDetails = {
			levelRange: {
				min: lvl.loyalty2.min,
				max: lvl.loyalty2.max,
			},
			equipment: {
				FirstPrimaryWeapon: [
					...(primaryWeaponLL2 && primaryWeaponFlea && primaryWeaponLL1),
				],
				SecondPrimaryWeapon: [
					...(primaryWeaponLL2 && primaryWeaponFlea && primaryWeaponLL1),
				],
		...
		const progressionWhitelistLL3PMC: IEquipmentFilterDetails = {
			levelRange: {
				min: lvl.loyalty3.min,
				max: lvl.loyalty3.max,
			},
		...
		const progressionWhitelistLL3PMCWide: IEquipmentFilterDetails = {
			levelRange: {
				min: lvl.loyalty3.min,
				max: lvl.loyalty3.max,
			},
			equipment: {
				FirstPrimaryWeapon: [
					...(primaryWeaponLL3 && primaryWeaponFlea && primaryWeaponLL2),
				],
				SecondPrimaryWeapon: [
					...(primaryWeaponLL3 && primaryWeaponFlea && primaryWeaponLL2),
				],
				...
				TacticalVest: [
					...(tacticalVestLL3 && tacticalVestFlea && tacticalVestLL2),
				],
		...
		const progressionWhitelistLL4PMC: IEquipmentFilterDetails = {
			levelRange: {
				min: lvl.loyalty4.min,
				max: 100,
			},
		...
		const progressionWhitelistLL4PMCWide: IEquipmentFilterDetails = {
			levelRange: {
				min: lvl.loyalty4.min,
				max: 100,
			},
			equipment: {
				FirstPrimaryWeapon: [
					...(primaryWeaponLL4 && primaryWeaponLL3 && primaryWeaponFlea),
				],
				SecondPrimaryWeapon: [
					...(primaryWeaponLL4 && primaryWeaponLL3 && primaryWeaponFlea),
				],
				...
				TacticalVest: [
					...(tacticalVestLL4 && tacticalVestLL3 && tacticalVestFlea),
				],
